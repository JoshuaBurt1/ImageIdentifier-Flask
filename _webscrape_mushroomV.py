#TO DO
# Create image identifier datasets (A. animal, bacteria, protist, fungi && B. all combined - test response speed & accuracy)
# 1. Organic: 
...
# Function to scrape images from MushroomExpert.com (06-24-2024) (VAL DATA)
# there are microscope images in thumbs that have not been downloading (microscope thumbs = unassociated thumbs - downloaded&thumbs)
                ...
                if a_tag:
                    ...
                    if len(tables) >= 3:
                        ...
                        for full_url in link_urls:
                            ...
                            # Wait for the page to load and stabilize after navigation
                            page.wait_for_load_state("networkidle")
...
#some folders that contain information end in .jpg; rename and merge if required
def rename_folders():
